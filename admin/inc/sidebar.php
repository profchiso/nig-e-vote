        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="admin.php"><i class="fa fa-star"></i> Administrator<span class="fa arrow"></span></a>
                    </li>
                    <li>
                        <a href="voters.php"><i class="fa fa-users"></i> Voters <span class="fa arrow"></span></a>
                    </li>
                    <li>
                        <a href="candidates.php"><i class="fa fa-user"></i> Candidates <span class="fa arrow"></span></a>
                    </li>
                    <li>
